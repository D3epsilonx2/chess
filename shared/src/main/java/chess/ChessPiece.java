...
public class ChessPiece {
     ...
     */
    private void addListedMoves(ChessBoard board, ChessPosition myPosition, List<ChessMove> mainList, ChessGame.TeamColor currentTeam, List<ChessPosition> checkList){
